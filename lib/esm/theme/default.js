export default {
    ...
    carousel: {
        ...
        indicators: {
            active: {
                off: 'bg-stone-50 hover:bg-white dark:bg-stone-50 dark:hover:bg-gray-800',
                on: 'bg-primaryBlue dark:primaryBlue',
            },
        ...
        control: {
            base: 'inline-flex h-8 w-8 items-center justify-center rounded-full bg-white group-hover:bg-white/50 group-focus:outline-none group-focus:ring-4 group-focus:ring-white dark:bg-gray-800/30 dark:group-hover:bg-gray-800/60 dark:group-focus:ring-gray-800/70 sm:h-10 sm:w-10',
            icon: 'h-5 w-5 text-primaryBlue dark:text-gray-800 sm:h-6 sm:w-6',
        },
